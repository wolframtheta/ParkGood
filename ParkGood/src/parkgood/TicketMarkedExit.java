 ...
 * @author Xavier
 */
public class TicketMarkedExit implements Printable {
    ...
    public int print(Graphics g, PageFormat pf, int page) throws PrinterException {
        ...
        g.drawString("N�mero Rebut:  " + MarkedCarExit.ticketTextField.getText(), 80, 80);
        
        g.drawString("Gr�scies per la seva visita", 80, 260);
        ...
        g.drawString(MarkedCarExit.entryDateLabel.getText(), 135, 120); //ENTRY DATE
        g.drawString(MarkedCarExit.entryTimeLabel.getText(), 135, 160); //ENTRY TIME
        g.drawString(MarkedCarExit.exitDateLabel.getText(), 135, 200); //EXIT DATE
        g.drawString(MarkedCarExit.exitTimeLabel.getText(), 135, 240); //EXIT TIME
        g.drawString(MarkedCarExit.ticketTextField.getText(), 0, 120);
        Double d = 0.0; 
        try {
            d = Utilities.round(Double.parseDouble(MarkedCarExit.priceLabel.getText())/(1.0 + IVA()/100), 2);
